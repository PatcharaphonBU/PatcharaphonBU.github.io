...
(async function(){  
    ...
    model = await tf.loadLayersModel("https://patcharaphonbu.github.io/models/model.json")
...
function preprocessCanvas(image) { 
    ...
    let tensor = tf.browser.fromPixels(image).resizeNearestNeighbor([224, 224]).mean(2).expandDims(2).expandDims().toFloat(); 
